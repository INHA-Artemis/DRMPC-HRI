...
class OnlineCTTraining:
    ...
    def pure_online_ct_training(self, run):
        ...
        # Only start updates when both warmup and minibatch requirements are met.
        data_before_training = max(self.config_training.data_before_training, self.config_training.batch_size)
